...
function Header() {
  ...
  return (
    <header className="fixed w-full top-0 flex items-center justify-between sm:justify-between  py-3 px-5 border-b-2 bg-gray-100 shadow-md z-20">
      {/* Logo / Title */}
      ...
      {/* Desktop Menu */}
      <nav className="hidden md:flex justify-between items-center gap-2 font-semibold text-gray-700 ">
        <NavLink
          to="/"
          className="hover:text-gray-900 transition-colors duration-300 bg-gradient-to-r from-green-500 to-green-700 text-white rounded-br-full rounded-tl-full text-center py-1.5 uppercase w-[120px] text-[17px]"
        >
          Home
        </NavLink>
        <NavLink
      ...
      {/* Mobile Menu Button */}
      <div className="md:hidden flex flex-col items-end text-center">
        <Sidebar />
      </div>
